...
def editplayerinfo():
    ...
    return render_template("editplayerinfo.html", players_list = players_list, success = success)
...
@app.route('/saveplayerinfo', methods=['POST', 'GET'])
def saveplayerinfo():
    players_list = Player.query.all()  
    ...
    return render_template("editplayerinfo.html", players_list = players_list)